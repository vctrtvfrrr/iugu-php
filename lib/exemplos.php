...
// exemplo de uso da classe BankVerification
    ...
    $updateBank = Iugu_BankVerification::create([
        'agency'               => '9999-9',
        'account'              => '999999-9',
    ...
    //
    // criar sub-conta
    $mktplace = Iugu_Marketplace::create([
